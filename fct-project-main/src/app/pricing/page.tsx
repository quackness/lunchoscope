...
<section className="w-full">
         <div className="mx-auto max-w-4xl text-center mt-10 items-center">
              {/* <h2 className="text-3xl font-semibold leading-7 text-[#f1592a]">Exclusive Member Pricing</h2> */}
         ...
         <div className="grid grid-cols-1 sm:grid-cols-3 mb-12 gap-8 max-w-[1040px] items-center mx-auto">
