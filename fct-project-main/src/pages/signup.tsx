...
<div className="flex flex-wrap flex-row md:flex-nowrap gap-6 mt-6 mb-3">
                    <div>
                        <button type="submit"
                            className="rounded-md border border-transparent bg-green-100 px-5 py-2.5 text-base text-green-900 hover:bg-green-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-green-500 focus-visible:ring-offset-2">
                            Sign Up
                        </button>
                    </div>
                ...
                <div>
                    <p className="justify-center text-slate-300 p-6">———————— or ————————</p>

                    <button className="btn btn-block text-base" onClick={() => { signIn("github") }} >
                        <svg className="h-6 w-6 mr-2" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 73 73" version="1.1">
                            <g id="team-collaboration/version-control/github" stroke="none" strokeWidth="1" fill="none"
                                ...
                                <g id="container" transform="translate(2.000000, 2.000000)" fillRule="nonzero">
                                    <rect id="mask" stroke="#5c5c5c" strokeWidth="2" fill="#5c5c5c" x="-1"
